...
//      역할(Role):
//          BankFSM들을 제어하고
//          CMD/ADDR 신호를 중재하기 위한
//          랭크 레벨 FSM.
//
//      주요 책임(Responsibilities):
//          - 단일 랭크에 대해
//            ACT / PRE / RD / WR / REF 명령을 실행.
//          - 랭크 및 뱅크 레벨 DRAM 타이밍 제약을 강제.
//          - CMD/DQ 버스 가용성을 위해
//            ChannelScheduler와 협조.
//          - 버퍼 요청을 발행하고
//            Auto-Precharge 동작을 처리.
//
...
//            (tRCD, tRP, tRFC).
//          - 요청 재정렬은 수행하지 않음.
//            (Out-of-order 요청 선택은 RankSched에서 수행됨)
//          - 한 번에 하나의 스케줄된 요청만 처리.
//
//      작성자  : 조성원
//      작성일  : 2026.02
//------------------------------------------------------------------------------
